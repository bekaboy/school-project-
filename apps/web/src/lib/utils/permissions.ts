...
const PERMISSIONS: PermissionMap = {
  ...
  'Technical Manager/Owner': [
    ...
    'product:manage', 'product:view', 'batch:manage', 'inventory:view',
    'inventory:adjust', 'customer:manage', 'customer:view',
    'payment:verify', 'payment:view', 'receipt:generate',
    'delivery:assign', 'delivery:view-all', 'delivery:view-assigned', 'delivery:update-status',
